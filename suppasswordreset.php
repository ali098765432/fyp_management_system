...
<div class="row justify-content-center">
 ...
 <div class="card-header"><h3 class="text-center font-weight-light my-4">Supervisor Reset Password</h3></div>
<div class="card-body">
   <form method="POST">
  <div class="form-floating mb-3">
    ...
    <input type="submit" name="loginsupreset" value="Send Reset Password Email" class="btn" style="background-color: #66023c;color: white;">
 ...
 if($check==1){
  ...
  //  $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
   ...
   // $mail->setFrom( $_POST['email']);
    ...
    $mail->addAddress($_POST['supname'],'LMS Password Reset');     //Add a recipient
//$_POST['email']
    //Content
    $mail->isHTML(true);
    ...
    $mail->Body="Supervisor Your New Lms Password:". $rand_refno;
