...
<div class="card-header"><h3 class="text-center font-weight-light my-4"><b>Import Supervisor Data</b></h3></div>
 <div class="card-body">
...
.$fileExtension;
$targetDirectory="supervisorimportdata/".$newFileName;
$getfiletmpname =$_FILES['studentdatafile']['tmp_name'];
      ...
      foreach ($reader as $key => $row) {
        ...
        $insertprop = "INSERT IGNORE INTO supervisor (id, name, email, password, year, department) 
               VALUES ('', '$name', '$email', '$password', '$year', '$department')";
