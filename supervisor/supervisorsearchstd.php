...
<h2 class="text-center" style="margin-top:20px;">Chat Boot</h2>
 <div class="card-body">
  ...
  <div class="form-group mx-sm-9 mb-2">
    ...
    <input type="text" class="form-control"  placeholder="Search  by name" name="searchq">
  </div>&nbsp &nbsp &nbsp
    ...
    <tr>
     ...
     <tbody>
          ...
          if(isset($_POST['searchbtn'])){
            ...
            $getpassstdid=$_POST['searchq'];
         

        $selpropdetail="select * from proposalfiles where supid ='$getuseridvalue' AND status='Accepted' AND 
        stdname LIKE '%$getpassstdid%'";
