...
<div class="card shadow-lg border-1 rounded-lg mt-5">
	<h1 class=" text-white" style="padding:2%;background-color: #66023c;">Notifications &nbsp
...
$selallquestion ="SELECT * FROM supervisornotification WHERE status='unread' AND supid='$getuseridvalue'";
...
<table class="table">
      ...
      <?php 
$selall ="SELECT * FROM supervisornotification 
Where supid='$getuseridvalue'  ORDER BY senttime DESC";
...
?>
    ...
    <tr style="background-color:lightgray;">
       ...
       <td> <a href="supervisor_viewsubmitproposalreport.php?nid=<?php  echo $rowfetch['id'] ?>"><?php echo $rowfetch['msg']  ?></a><br>
       <span>Date: &nbsp <?php 
       $gtingdate= $rowfetch['senttime'];


       echo date('y-m-d',strtotime($gtingdate)) ; ?>&nbsp &nbsp Time :   <?php 
       $gtingdatee= $rowfetch['senttime'];
    ...
    <tr style="background-color:lightgray;">
       ...
       <td> <a href="supervisor_viewnotificationsubmission.php?nid=<?php  echo $rowfetch['id'] ?>&npid=<?php echo $rowfetch['pid']?>"><?php echo $rowfetch['msg']  ?></a><br>
