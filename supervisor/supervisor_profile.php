...
<div class="col-md-12">
 ...
 <input class="form-control" id="inputqty" type="text" placeholder="name" required name="supname" value="<?php echo  $getusernamevalue;?>" readonly>
...
<div class="col-md-12">
 ...
 <input class="form-control" id="inputqty" type="text" placeholder="year" required name="supyear" value="<?php echo  $getuseryearvalue;?>" readonly>
