...
<body class="sb-nav-fixed">
    ...
    <thead>
    <a href="#" class="btn form-control btn-xs pull-right" style="background-color: #66023c;color:white;">Accepted Proposals</a>
        <tr>
            <th>Sr No</th>
            <th>Student Name</th>
            <th>Proposal Name</th>
...
$fetchfullname =$fetchsupname['firstname'] . " " .     $fetchsupname['lastname'];                                              
        ...
        <tr>
         <td><?php  echo $xi++;?></td>
            ...
            <td><a href="supervisor_addmission.php?pid=<?php  echo $rowprop['id']; ?>" class="btn btn-success"  style="font-size:12px;" >Add Submission </a>
              <a href="supervisor_viewcompletesubmissionofsingleuser.php?pid=<?php  echo $rowprop['id']; ?>" class="btn btn-primary"  style="font-size:12px;">View Submission Report</a>
              <a href="supervisor_viewcompleteweeklyreport.php?uid=<?php  echo $getsupid; ?>" class="btn btn-warning"  style="font-size:12px;">Weekly Report</a>
