...
<div class="card-body">
   <form method="post" action="upload_studentlogin.php">
...
<label for="inputPassword">Password</label>
     <input class="form-control" id="inputPassword" type="password" placeholder="Password" name="stdpassword" required />

  </div>

    <div class="d-flex align-items-center justify-content-between mb-0 float-right">
       <a class="" href="stdpasswordreset.php" style="color:#66023c;margin-top:-1%;">Forget Password?</a>
    ...
    <input type="submit" name="loginstudent" value="login" class="btn" style="background-color:#66023c;color:white;">
